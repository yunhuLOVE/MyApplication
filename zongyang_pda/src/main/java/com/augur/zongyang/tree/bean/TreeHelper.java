...

    {
        ...
        for (T t : datas) {
            ...
            for (Field f : declaredFields) {
                ...
                if (f.getAnnotation(TreeNodeProjectId.class) != null) {
                    f.setAccessible(true);
                    parentId = (String) f.get(t);
                }
                if (f.getAnnotation(TreeNodeItemId.class) != null) {
                    f.setAccessible(true);
                    itemId = (String) f.get(t);
                }
                if (id != null && pId != null && label != null && parentId != null) {
                    break;
                }
            }
            node = new Node(id, pId, label, parentId, itemId);
            nodes.add(node);
        }
